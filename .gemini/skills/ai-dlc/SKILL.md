---
name: ai-dlc
description: AI-Driven Development Life Cycle (AI-DLC) adaptive workflow for software development. Use when the user says "Using AI-DLC" or requests structured development with requirements, design, and implementation phases.
---
...
1. Read the full workflow from `GEMINI.md` or `.kiro/steering/aws-aidlc-rules/core-workflow.md`
